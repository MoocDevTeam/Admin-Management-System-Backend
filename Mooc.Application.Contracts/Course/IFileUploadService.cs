...
namespace Mooc.Application.Contracts.Course
{
    ...
    public interface IFileUploadService
    {
        ...
        Task<string> UploadLargeFileAsync(IFormFile file, string folderName, long sessionId, string uploadId, int partSizeMb = 5, IProgress<UploadProgress> progress = null);
    }
}
