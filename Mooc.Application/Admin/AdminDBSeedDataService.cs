...
namespace Mooc.Application.Admin
{
    ...
    public class AdminDBSeedDataService : IDBSeedDataService, ITransientDependency
    {
        ...
        {
            new User(){Id=1, UserName="user1", Password=BCryptUtil.HashPassword("123456"), Email="admin@demo.com", Age=30, Address= "5000, Australia",Access=Access.admin, Gender=Gender.Male, Avatar="admin-avatar.png", CreatedAt=DateTime.Now, CreatedByUserId=1,IsActive=true },
            new User(){Id=2, UserName="user2", Password=BCryptUtil.HashPassword("123456"), Email="teacher1@demo.com", Age=35, Address= "5000, Australia", Access=Access.teacher, Gender=Gender.Male, Avatar="teacher1-avatar.png", CreatedAt=DateTime.Now.AddMinutes(1), CreatedByUserId=1, IsActive=true },
            new User(){Id=3, UserName="user3", Password=BCryptUtil.HashPassword("123456"), Email="teacher2@demo.com", Age=32, Address= "5000, Australia", Access=Access.teacher, Gender=Gender.Female, Avatar="teacher2-avatar.png", CreatedAt=DateTime.Now.AddMinutes(2), CreatedByUserId=1, IsActive=true },
            new User(){Id=4, UserName="user4", Password=BCryptUtil.HashPassword("123456"), Email="student1@demo.com", Age=20, Address= "5000, Australia", Access=Access.student, Gender=Gender.Male, Avatar="student1-avatar.png", CreatedAt=DateTime.Now.AddMinutes(3), CreatedByUserId=1, IsActive=true },
            new User(){Id=5, UserName="user5", Password=BCryptUtil.HashPassword("123456"), Email="student2@demo.com", Age=21, Address= "5000, Australia", Access=Access.student, Gender=Gender.Female, Avatar="student2-avatar.png", CreatedAt=DateTime.Now.AddMinutes(4), CreatedByUserId=1, IsActive=true },
            new User(){Id=6, UserName="user6", Password=BCryptUtil.HashPassword("123456"), Email="student3@demo.com", Age=22, Address= "5000, Australia", Access=Access.student, Gender=Gender.Male, Avatar="student3-avatar.png", CreatedAt=DateTime.Now.AddMinutes(5), CreatedByUserId=1, IsActive=true }
