...
namespace Mooc.Application.Admin
{
    ...
    public class AdminDBSeedDataService : IDBSeedDataService, ITransientDependency
    {
        ...
        {
            new User(){Id=1, UserName="user1", Password=BCryptUtil.HashPassword("123456"), Email="admin@demo.com", Age=30, Access=Access.admin, Gender=Gender.Male, Avatar="https://moocmedia.s3.us-east-1.amazonaws.com/avatars/user4/user4.jpg", CreatedAt=DateTime.Now, IsActive=true },
            new User(){Id=2, UserName="user2", Password=BCryptUtil.HashPassword("123456"), Email="teacher1@demo.com", Age=35, Access=Access.teacher, Gender=Gender.Male, Avatar="https://moocmedia.s3.us-east-1.amazonaws.com/avatars/user4/user4.jpg", CreatedAt=DateTime.Now.AddMinutes(1), IsActive=true },
            new User(){Id=3, UserName="user3", Password=BCryptUtil.HashPassword("123456"), Email="teacher2@demo.com", Age=32, Access=Access.teacher, Gender=Gender.Female, Avatar="https://moocmedia.s3.us-east-1.amazonaws.com/avatars/user4/user4.jpg", CreatedAt=DateTime.Now.AddMinutes(2), IsActive=true },
            new User(){Id=4, UserName="user4", Password=BCryptUtil.HashPassword("123456"), Email="student1@demo.com", Age=20, Access=Access.student, Gender=Gender.Male, Avatar="https://moocmedia.s3.us-east-1.amazonaws.com/avatars/user4/user4.jpg", CreatedAt=DateTime.Now.AddMinutes(3), IsActive=true },
            new User(){Id=5, UserName="user5", Password=BCryptUtil.HashPassword("123456"), Email="student2@demo.com", Age=21, Access=Access.student, Gender=Gender.Female, Avatar="https://moocmedia.s3.us-east-1.amazonaws.com/avatars/user4/user4.jpg", CreatedAt=DateTime.Now.AddMinutes(4), IsActive=true },
            new User(){Id=6, UserName="user6", Password=BCryptUtil.HashPassword("123456"), Email="student3@demo.com", Age=22, Access=Access.student, Gender=Gender.Male, Avatar="https://moocmedia.s3.us-east-1.amazonaws.com/avatars/user4/user4.jpg", CreatedAt=DateTime.Now.AddMinutes(5), IsActive=true }
