...
namespace Mooc.Application.Course
{
    public class CourseDBSeedDataService : IDBSeedDataService, ITransientDependency
    {
        ...
        //{
        //    new MoocCourseInstance(){Id=1, SesssionId=1,CourseId=1,TeacherId=1,StartDate=1,EndDate=1,TotalSessions=1,OpenStatus= OpenStatus.Open, Permission=Permission.Private, CreatedByUserId=1, UpdatedByUserId=1, CreatedAt=DateTime.Now, UpdatedAt=DateTime.Now  },
