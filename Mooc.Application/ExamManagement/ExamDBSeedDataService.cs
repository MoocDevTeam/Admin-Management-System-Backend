...
namespace Mooc.Application.ExamManagement
{
    public class ExamDBSeedDataService : IDBSeedDataService, ITransientDependency
    {
        ...
        {
            new Exam(){Id=1, ExamTitle="Exam1", Remark=100, ExaminationTime=120, AutoOrManual=QuestionUpload.Manual, TotalScore=100, TimePeriod=120, CreatedByUserId=1, CreatedAt=DateTime.Now, UpdatedByUserId=1, UpdatedAt=DateTime.Now,},
            new Exam(){Id=2, ExamTitle="Exam2", Remark=100, ExaminationTime=120, AutoOrManual=QuestionUpload.Auto, TotalScore=100, TimePeriod=120, CreatedByUserId=1, CreatedAt=DateTime.Now, UpdatedByUserId=1, UpdatedAt=DateTime.Now,},
        };
        ...
        {
            new ExamPublish(){Id=1, ExamId=1,PublishedAt=DateTime.Now, PublishedByUserId=1, CloseAt=DateTime.Now, },
            new ExamPublish(){Id=2, ExamId=2,PublishedAt=DateTime.Now, PublishedByUserId=1, CloseAt=DateTime.Now, },
        };
