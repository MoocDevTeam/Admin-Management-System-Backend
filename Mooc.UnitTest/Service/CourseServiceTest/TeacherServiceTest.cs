    ...
    public class TeacherServiceTest 
    {
        ...
        [Test]
            public async Task CreateAsync_Should_Call_ValidateId_And_Return_TeacherReadDto()
            {
                ...
                var teacherEntity = new Teacher { Id = 1, UserId = userId, Title="Professor", Department="Finance", Expertise="xxx", HiredDate=DateTime.UtcNow, IsActive=false, CreatedAt= DateTime.Now, Introduction="222", Office="Room222" };
